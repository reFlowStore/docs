...
To get started first download your asset previously purchased from [reflow-store.com](https://reflow-store.com/) login into [keymaster](keymaster.fivem.net) and you will find it under the option **Granted Assets**
 
### Installation
 
Open the downloaded resource zip file and drag the folder into your folders resources folder
