...
Config.Animals = {
    ['bear'] = { Model = `BrnBear`, Size = 1, Tracks = `bear_track`, HeadingOffset = 270, Sound = 'default.ogg', MinWeight = 500, MaxWeight = 1500 },
    ['boar'] = { Model = `a_c_boar`, Size = 2, Tracks = `boar_track`, HeadingOffset = 90, Call = 'boarcall.mp3', Sound = 'boarreply.mp3', MinWeight = 200, MaxWeight = 450 },
    ['deer'] = { Model = `a_c_deer`, Size = 2, Tracks = `deer_track`, HeadingOffset = 270, Call = 'deercall.wav', Sound = 'deerreply.wav', MinWeight = 80, MaxWeight = 160 },
    ['lion'] = { Model = `a_c_mtlion`, Size = 2, Tracks = `deer_track`, HeadingOffset = 270, Sound = 'default.ogg', MinWeight = 90, MaxWeight = 175 },
    ['panther'] = { Model = `a_c_panther`, Size = 2, Tracks = `deer_track`, HeadingOffset = 270, Sound = 'default.ogg', MinWeight = 90, MaxWeight = 175 },
    ['rabbit'] = { Model = `a_c_rabbit_01`, Size = 3, Tracks = `rabbit_track`, HeadingOffset = 270, Sound = 'default.ogg', MinWeight = 4, MaxWeight = 15 },
    ['coyote'] = { Model = `a_c_coyote`, Size = 3, Tracks = `rabbit_track`, HeadingOffset = 270, Sound = 'default.ogg', MinWeight = 15, MaxWeight = 46 },
    ['skunk'] = { Model = `Skunk`, Size = 3, Tracks = `skunk_track`, HeadingOffset = 270, Sound = 'default.ogg', MinWeight = 3, MaxWeight = 12 },
    ['cormorant'] = { Model = `a_c_cormorant`, Size = 4, Tracks = nil, HeadingOffset = 270, Call = 'birdcall.mp3', Sound = 'birdcall.mp3', MinWeight = 2, MaxWeight = 6 },
}
...
Config.NPCShop = {
    { name = 'animaltag',       price = 25 }, -- You can add ",count = 100" after price to make it so only 100 will be sold, can change the number and add to all
    { name = 'scentremover',    price = 50 },
    { name = 'huntingbrochure', price = 75 },
    { name = 'bearspray',       price = 100 },
    { name = 'hbait',           price = 250 },
    { name = 'cbait',           price = 300 },

    { name = 'deercall',        price = 450 },
    { name = 'boarcall',        price = 500 },
    { name = 'birdcall',        price = 500 },
    { name = 'ammo-sniper',           price = 10 },


    { name = 'WEAPON_SNIPERRIFLE', price = 1000 }, -- MAKE SURE TO CHANGE THIS IF YOU USE A DIFFERENT WEAPON
